    ...
    <div className="bg-pondo-blue">
        <footer className="text-white px-4 py-5 max-w-screen-xl mx-auto">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                ...
                Sagittis eu volutpat odio facilisis mauris sit amet. Amet luctus venenatis lectus magn
                a fringilla urna porttitor rhoncus. Semper viverra nam libero justo laoreet sit. Pelle
                ntesque id nibh tortor id aliquet. 
                </p>
            </div>
